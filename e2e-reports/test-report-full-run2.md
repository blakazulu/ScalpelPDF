...
**Total:** 203 &nbsp; **Passed:** 81 &nbsp; **Failed:** 122 &nbsp; **Untested controls:** 0
...
```
2026-06-21T07:33:11.3140000Z INFO UI/click ToggleButton
```
...
**Reason:** ModeSignTab is not selected after click

### [journeys] settings:theme-blood

**Reason:** expected click 'ThemeBloodRadio' not logged

### [journeys] settings:theme-dark
